...
## 1. Get the site indexed by Google ("Minh's Blog")

Two things were blocking this; the homepage fix is already in code (the old
meta-refresh redirect is gone, replaced by a real landing page). You still need
to verify ownership and ask Google to crawl:
...
## 2. Activate the newsletter (Buttondown)
